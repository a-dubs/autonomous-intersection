...
namespace Simulation_V2
{
    public static class Vars
    {
        ...
        public static float PPM = 12;  // Pixels Per Meter; Gives scale to the simulation;
        public static int NumberOfLanes = 1;
        public static double CarFrequency = 60;  // cars spawning in per minute 
        public static int MaxNumberOfVehicles = NumberOfLanes*30;  // max possible number of car on screen
        ...
        public static double ETABuffer = 1.3;  // window of time (in seconds) that cars must guarantee between themselves when avoid potential collisions
        ...
        public static double PedestrianFrequency = 3;  // pedestrians spawning in per minute 

        public static double LeftTurnPct = .15;
        public static double StraightPct = .5;
        public static double RightTurnPct = .35;
        ...
        public static double LaneWidth = 5; //width of lanes in meters (3.7)
